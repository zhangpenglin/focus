...
function playVideo(a) {
    if (a && a.bgAudio) {
        var b, c = $("#media"), d = $("#audio_btn"), e = $("#yinfu");
        a.bgAudio.url ? b = 0 == a.bgAudio.url.indexOf("http://") ? a.bgAudio.url : PREFIX_FILE_HOST + a.bgAudio.url : !a.bgAudio.url && a.bgAudio.src && (b = 0 == a.bgAudio.src.indexOf("http://") ? a.bgAudio.src : PREFIX_FILE_HOST + a.bgAudio.src),
        c.attr("src", b),
        d.addClass("video_exist"),
        ...
        d.show().click(function(a) {
            a.stopPropagation(),
            $(this).hasClass("off") ? (c.get(0).play(),
            utilSound.pause()) : c.get(0).pause()
        }
        )
    }
}
...
function(a) {
    flux.slider = function(b, c) {
        ...
        for (var g = 0; g < this.images.length; g++) {
            ...
            h.onload = function() {
                ...
                d.imageLoadedCount >= d.images.length && (d.finishedLoading(),
                d.setupImages())
            }
            ,
        ...
        this.element.bind("fluxTransitionEnd", function(a, b) {
            d.options.onTransitionEnd && (a.preventDefault(),
    ...
    flux.slider.prototype = {
        ...
        finishedLoading: function() {
            ...
            this.options.pagination && (this.pagination = a('<ul class="pagination"></ul>').css({
                margin: "0px",
                padding: "0px",
                "text-align": "center"
            }),
        ...
        setupImages: function() {
            ...
            a(b).data("href") ? (c.cursor = "pointer",
            this.image1.addClass("hasLink"),
            this.image1.data("href", a(b).data("href"))) : (this.image1.removeClass("hasLink"),
        ...
        updateCaption: function() {
            ...
            this.options.captions && this.captionBar && ("" !== b && this.captionBar.html(b),
    ...
    flux.browser = {
        init: function() {
            if (void 0 === flux.browser.supportsTransitions) {
                ...
                ["-webkit", "-moz", "-o", "-ms"]);
                if (window.Modernizr && void 0 !== Modernizr.csstransitions ? flux.browser.supportsTransitions = Modernizr.csstransitions : flux.browser.supportsTransitions = this.supportsCSSProperty("Transition"),
                window.Modernizr && void 0 !== Modernizr.csstransforms3d)
                    flux.browser.supports3d = Modernizr.csstransforms3d;
                else if (flux.browser.supports3d = this.supportsCSSProperty("Perspective"),
                flux.browser.supports3d && "webkitPerspective" in a("body").get(0).style) {
    ...
    flux.transitions.blocks = function(b, c) {
        return new flux.transition_grid(b,a.extend({
            ...
            renderTile: function(b, c, d, e, f, g, h) {
                ...
                i > this.maxDelay && (this.maxDelay = i,
                this.maxDelayTile = b)
            },
            execute: function() {
                var b = this
...
function(a) {
    ...
    var i = a.templateParser("jsonParser", function() {
        ...
        function b(a, b) {
            ...
            if (c) {
                ...
                if (3 != ("" + a.type).charAt(0) && 1 != ("" + a.type).charAt(0) && e.attr("comp-resize", ""),
                ...
                f = 0; f < i.length; f++)
                    if (3 == i[f].type) {
                        ...
                        for (var p = 0; p < o.length; p++)
                            o[p](k, i[f], e);
                        n[("" + i[f].type).charAt(0)] && (n[("" + i[f].type).charAt(0)](k, i[f]),
                        "edit" != e && (g(k, i[f]),
                        h(k, i[f]))),
    ...
    i.addComponent("3", function(a) {
        ...
        "edit" == i.mode ? (b = $("#nr .edit_wrapper"),
        c.setAttribute("class", "wrapper-background"),
        c.setAttribute("id", a.id)) : "view" == i.mode && (b = $("#edit_area" + i.def.id).parent(".edit_wrapper"),
        c.setAttribute("id", "wrapper-background" + i.def.id)),
        $(c).prependTo(b).css({
            width: "100%",
            height: "100%"
        });
    ...
    i.addComponent("8", function(a) {
        ...
        $(b).html(c),
        "view" == i.mode && $(b).attr("href", "tel:" + a.properties.number)) : a.properties.title && (c = a.properties.title.replace(/ /g, "&nbsp;"),
        $(b).html(c),
    ...
    i.addComponent("i", function(b) {
        ...
        if (d.append(e),
        "view" == i.mode ? a.counterValues && a.counterValues.then(function(a) {
            var c = a.map[b.id] || 0;
            e.text(c)
        }
        ) : c.removeClass("not-voted"),
        c.width("100%"),
        "counter-tb" === b.properties.layout) {
            var f = 0;
            f = b.properties.imgSrc ? "counter-l" == b.properties.size ? 77 : "counter-m" == b.properties.size ? 71 : 66 : "counter-l" == b.properties.size ? 40 : "counter-m" == b.properties.size ? 30 : 20,
            d.css("margin-top", -f)
        }
        return c.append(d),
    ...
    i.bindAfterRenderEvent("s", function(a, b) {
        a = $("a", a)[0],
        "view" == i.mode && $(a).click(function(a) {}
        )
    }
    ),
        ...
        "view" == i.mode) {
            ...
            var d = function(b, d) {
                var e = !0
                  , f = $(a).parents(".nr")
                  , g = {};
                if ($("textarea", f).each(function() {
                    if (e) {
                        if ("required" == $(this).attr("required") && "" == $(this).val().trim())
                            return alert($(this).attr("placeholder") + c.REQUIRED),
                            void (e = !1);
                ...
                $('.comp_radio[required="required"]', f).each(function() {
                    var a = $(this);
                    g[a.attr("name")] || (alert(a.attr("title") + c.REQUIRED),
                    e = !1)
                }
                ),
                ...
                $('.comp_rating[required="required"]', f).each(function() {
                    var a = $(this);
                    g[a.attr("name")] && "0" != g[a.attr("name")] || (alert(a.attr("title") + c.REQUIRED),
                    e = !1)
                }
                ),
                e) {
      ...
      , b = function(a, b, c) {
        ...
        if (b.properties && b.properties.anim) {
            ...
            for (var h, i = [], j = [], k = 0, l = f.length; l > k; k++)
                null  != f[k].type && -1 != f[k].type && (h = eqxCommon.convertType(f[k]),
                i.push(h),
                j.push(f[k]));
...
function(a) {
    ...
    a.fn.ShareLink = function(c) {
        function d(a) {
            var b = g[a];
            return b = b.replace("{url}", encodeURIComponent(c.url)),
            b = b.replace("{title}", encodeURIComponent(c.title)),
            b = b.replace("{text}", encodeURIComponent(c.text)),
            b = b.replace("{image}", encodeURIComponent(c.image))
        }
        var e = {
            title: "",
            text: "",
...
function(a) {
    function b(a, b, i) {
        ...
        this.getHash = function(a, b, c, d) {
            ...
            if (3 === arguments.length ? "number" != typeof c && (d = c,
        ...
        this.getHMAC = function(a, b, i, m, n) {
            ...
            if ("SHA-1" !== i)
                throw "Unexpected error in HMAC implementation";
            return i = o(u.concat(o(t.concat(k), a + j)), a + s),
            m(i, h(n))
        }
    }
    function c(a, b) {
        ...
        if ("UTF8" === b)
            for (d = 0; d < a.length; d += 1)
                for (c = a.charCodeAt(d),
                f = [],
                c > 2048 ? (f[0] = 224 | (61440 & c) >>> 12,
                f[1] = 128 | (4032 & c) >>> 6,
                f[2] = 128 | 63 & c) : c > 128 ? (f[0] = 192 | (1984 & c) >>> 6,
                f[1] = 128 | 63 & c) : f[0] = c,
                c = 0; c < f.length; c += 1)
                    e[g >>> 2] |= f[c] << 24 - g % 4 * 8,
                    g += 1;
    ...
    function e(a) {
        ...
        for (c = 0; c < a.length; c += 4) {
            for (f = a.substr(c, 4),
            d = e = 0; d < f.length; d += 1)
                b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(f[d]),
                e |= b << 18 - 6 * d;
            for (d = 0; d < f.length - 1; d += 1)
                g[h >> 2] |= (e >>> 16 - 8 * d & 255) << 24 - h % 4 * 8,
                h += 1
        }
        return {
            value: g,
    ...
    function f(a, b) {
        ...
        for (c = 0; f > c; c += 1)
            d = a[c >>> 2] >>> 8 * (3 - c % 4),
            e += "0123456789abcdef".charAt(d >>> 4 & 15) + "0123456789abcdef".charAt(15 & d);
        return b.outputUpper ? e.toUpperCase() : e
    }
    function g(a, b) {
        var c, d, e, f = "", g = 4 * a.length;
        for (c = 0; g > c; c += 3)
            for (e = (a[c >>> 2] >>> 8 * (3 - c % 4) & 255) << 16 | (a[c + 1 >>> 2] >>> 8 * (3 - (c + 1) % 4) & 255) << 8 | a[c + 2 >>> 2] >>> 8 * (3 - (c + 2) % 4) & 255,
            d = 0; 4 > d; d += 1)
    ...
    function o(a, b) {
        ...
        o = 0; q > o; o += 16) {
            ...
            g = y[4],
            p = 0; 80 > p; p += 1)
                r[p] = 16 > p ? a[p + o] : v(r[p - 3] ^ r[p - 8] ^ r[p - 14] ^ r[p - 16], 1),
                h = 20 > p ? x(v(c, 5), s(d, e, f), g, 1518500249, r[p]) : 40 > p ? x(v(c, 5), t(d, e, f), g, 1859775393, r[p]) : 60 > p ? x(v(c, 5), u(d, e, f), g, 2400959708, r[p]) : x(v(c, 5), t(d, e, f), g, 3395469782, r[p]),
                g = f,
                f = e,
                e = v(d, 30),
                d = c,
    ...
    function b(a) {
        if ("loading" != f[a.url]) {
            ...
            "image" == a.type) {
                ...
                "js" == a.type && (f[a.url] = "loading",
                $.getScript(a.url, function(b, c, e) {
                    f[a.url] = !0,
                    d() && g.forEach(function(a) {
                        a()
                    }
...
function(a, b) {
    function c(a, c) {
        completeEffect(b(".z-current")) && (C = "started",
        B.length || (B = l.find(".main-page")),
        c || (z ? (a = event,
        o = {
    ...
    function d(a, c) {
        if (C = "turning",
        U.obj.property.autoFlip && U.obj.property.autoFlipTime && k(),
        c || (z ? (a = event,
        p = {
            x: a.touches[0].pageX - l.offset().left,
            y: a.touches[0].pageY - l.offset().top
        ...
        0 > q) {
            if (v) {
                ...
                if (m = b("#flip" + d),
                X || (x = b(w).parent(".flip-mask").get(0).nextElementSibling && b(b(w).parent(".flip-mask").get(0).nextElementSibling).find(".main-page").get(0) ? b(b(w).parent(".flip-mask").get(0).nextElementSibling).find(".main-page").get(0) : y ? B.first().get(0) : !1),
                x) {
            ...
            m = b("#flip" + d),
            X || (x = b(w).parent(".flip-mask").get(0).previousElementSibling && b(b(w).parent(".flip-mask").get(0).previousElementSibling).find(".main-page").get(0) ? b(b(w).parent(".flip-mask").get(0).previousElementSibling).find(".main-page").get(0) : y ? B.last().get(0) : !1),
            x && (i(x),
            completeEffect(b(x)) || b("#audio_btn").css("opacity", 0),
            b(w).parent(".flip-mask").css({
                display: "block"
    ...
    function e(a, b) {
        ...
        var c, d, e, g;
        b ? (c = a.x,
        d = a.y) : z ? (c = p.x - l.offset().left,
        d = p.y - l.offset().top) : (c = a.pageX - l.offset().left,
    ...
    function f(a) {
        r || s ? (F = l.width() - a.x,
        r ? G = Math.abs(l.height() - a.y) : s && (G = a.y),
        H = G / F,
        I = G / Math.sqrt(F * F + G * G),
        J = Math.sqrt(1 - I * I),
        K = Math.sqrt(F * F + G * G) / 2,
        L = K * H,
        M = Math.sqrt(L * L + K * K),
        N = M / H,
        E = 180 * Math.atan(H) / Math.PI > 0 ? 180 * Math.atan(H) / Math.PI : 0,
        O = (l.width() - M) * J,
        P = (l.width() - M) * I * J,
        Q = (l.width() - M) * (1 - I * I),
        O >= 1 && (r ? (E > 1 ? b(".turning").css({
            width: M + "px",
            height: N + "px",
        ...
        R = "0% 100% 0px",
        S = "rotate(-" + (90 - E) + "deg) translateY(" + O + "px)",
        T = "rotate(" + (90 - E) + "deg) translateY(-" + P + "px) translateX(-" + Q + "px)") : s && (E > 1 ? b(".turning").css({
            width: M + "px",
            height: N + "px",
            backgroundColor: "#000",
            background: "-webkit-linear-gradient(-" + (180 - E) + "deg, #fff 10%, #d1cfc7 40%, #f2eee2 50%, transparent 50%, transparent 100%)",
        ...
        R = "0% 0% 0px",
        S = "rotate(" + (90 - E) + "deg) translateY(-" + O + "px)",
        T = "rotate(-" + (90 - E) + "deg) translateY(" + P + "px) translateX(-" + Q + "px)"),
        m.css({
            zIndex: 100,
            transformOrigin: R,
            transform: S
    ...
    function h() {
        var a = U.list;
        U.obj.property.autoFlip && U.obj.property.autoFlipTime && j(),
        utilSound.pause();
        var c = b("#report0");
        c.length && c.remove(),
        C = "feeling",
    ...
    a.turnBook = function(a) {
        U = a,
        U.obj.property.autoFlip && U.obj.property.autoFlipTime && (V = U.obj.property.autoFlipTime,
        j()),
        y = U.obj.property.triggerLoop,
        ...
        l.on(z ? "touchstart" : "mousedown", function(a) {
            ...
            return X = !1,
            b(".z-current").get(0) ? 0 == q ? (v = !0,
            void (C = "feeling")) : void ("turning" == C && e(a)) : void 0
        }
        )
    }
    ;
    ...
    a.flipBookScroll = function(a) {
        ...
        g && (x = b(g).parent(".main-page").get(0),
        f > c ? turnBookPrePage() : c > f && turnBookNextPage())
    }
    ,
...
var eqxiu = function() {
    function a(a) {
        if ("10" != f._scrollMode) {
            q = !0;
            for (var d, e = 0, g = f._pageData.length; g > e; e++)
                a == f._pageData[e].id && (d = f._pageData[e].num);
            d || (d = a);
            var h = $(f.$currentPage).find(".m-img").attr("id").substring(4)
              , i = $(f.$currentPage).siblings(".main-page").find("#page" + d);
            if (!i)
                return;
            f.$activePage = $(i).parent(".main-page").get(0),
            h > d ? b() : d > h && c()
        } else
            flipBookScroll(a)
    }
    function b() {
        if ("10" != f._scrollMode) {
            ...
            var b = setInterval(function() {
                a += 2,
                "0" == f._scrollMode || "1" == f._scrollMode || "2" == f._scrollMode || "6" == f._scrollMode || "7" == f._scrollMode || "8" == f._scrollMode || "11" == f._scrollMode || "12" == f._scrollMode ? v = a : ("3" == f._scrollMode || "4" == f._scrollMode || "5" == f._scrollMode || "9" == f._scrollMode) && (u = a),
                h(),
                a >= 21 && (clearInterval(b),
                i())
            }
            , 1)
        } else
    ...
    function c() {
        if ("10" != f._scrollMode) {
            ...
            var b = setInterval(function() {
                ...
                "0" == f._scrollMode || "1" == f._scrollMode || "2" == f._scrollMode || "6" == f._scrollMode || "7" == f._scrollMode || "8" == f._scrollMode || "11" == f._scrollMode || "12" == f._scrollMode ? v = a : ("3" == f._scrollMode || "4" == f._scrollMode || "5" == f._scrollMode || "9" == f._scrollMode) && (u = a),
                h(),
                -21 >= a && (clearInterval(b),
                i(),
                p || f.$activePage || clearInterval(n))
            }
            , 1)
        } else
            turnBookNextPage()
    ...
    var f, g, h, i, j, k, l, m, n, o = $(window), p = !1, q = !1, r = mobilecheck(), s = 0, t = 0, u = 0, v = 0, w = !1, x = !1, y = !0, z = 500, A = .4, B = function(a, b, c, e) {
        function l(a, b, c) {
        ...
        function B() {
            ...
            var a;
            "0" == b || "1" == b || "2" == b || "6" == b || "9" == b || "11" == b || "12" == b ? (a = v > 0 ? -k : k,
            n($(f.$activePage), "transform", "translateY(" + a + "px)"),
            n($(f.$currentPage), "transform", "translateY(0) scale(1)")) : ("3" == b || "5" == b) && (a = u > 0 ? -j : j,
            n($(f.$activePage), "transform", "translateX(" + a + "px)"),
            n($(f.$currentPage), "transform", "translateX(0) scale(1)")),
            setTimeout(function() {
                $(f.$currentPage).attr("style", ""),
                $(f.$activePage).attr("style", ""),
                $(f.$activePage).removeClass("z-active z-move"),
                f._isDisableFlipPage = !1
            }
            , 500)
        }
        function C() {
            if (Math.abs(v) > Math.abs(u) && completeEffect($(f.$currentPage)))
                if (v > 0) {
                    if (f._isDisableFlipPrevPage)
                        return;
                    x || y ? (x = !1,
                    y = !1,
                    U(!0),
                    V(!0, "bottom center", "translateY", k)) : W(!0, "translateY", k, v, f._scrollMode)
                } else if (0 > v) {
                    if (f._isDisableFlipNextPage)
                        return;
                    !x || y ? (x = !0,
                    y = !1,
                    U(!1),
                    V(!1, "top center", "translateY", k)) : W(!1, "translateY", k, v, f._scrollMode)
                }
        }
        function D() {
            Math.abs(v) > Math.abs(u) && Math.abs(v) > 20 ? (X("translateY", v, k, f._scrollMode),
            $(document).trigger("flipend")) : (f._isDisableFlipPage = !1,
            B())
        }
        function E() {
            if (Math.abs(u) > Math.abs(v) && completeEffect($(f.$currentPage)))
                if (u > 0) {
                    if (f._isDisableFlipPrevPage)
                        return;
                    x || y ? (x = !1,
                    y = !1,
                    U(!0),
                    V(!0, "center right", "translateX", j)) : W(!0, "translateX", j, u, f._scrollMode)
                } else if (0 > u) {
                    if (f._isDisableFlipNextPage)
                        return;
                    !x || y ? (x = !0,
                    y = !1,
                    U(!1),
                    V(!1, "center left", "translateX", j)) : W(!1, "translateX", j, u, f._scrollMode)
                }
        }
        function F() {
            Math.abs(u) > Math.abs(v) && Math.abs(u) > 20 ? (X("translateX", u, j, f._scrollMode),
            $(document).trigger("flipend")) : (f._isDisableFlipPage = !1,
            B())
        }
        function G() {
            if (Math.abs(u) > Math.abs(v) && completeEffect($(f.$currentPage)))
                if (u > 0) {
                    ...
                    y = !1,
                    U(!0),
                    j = r ? window.innerWidth : $(".nr").width(),
                    V(!0, "", "translateX", j)) : W(!0, "translateX", j, u, f._scrollMode)
                } else if (0 > u) {
                    if (f._isDisableFlipNextPage)
                        return;
                    !x || y ? (x = !0,
                    ...
                    U(!1),
                    j = r ? window.innerWidth : $(".nr").width(),
                    V(!1, "", "translateX", j)) : W(!1, "translateX", j, u, f._scrollMode)
                }
        }
        function H() {
            Math.abs(u) > Math.abs(v) && Math.abs(u) > 20 ? (X("translateX", u, j, f._scrollMode),
        ...
        function I() {
            if (Math.abs(v) > Math.abs(u) && completeEffect($(f.$currentPage)))
                if (v > 0) {
                    ...
                    y = !1,
                    U(!0),
                    k = r ? window.innerHeight : $(".nr").height(),
                    V(!0, "", "translateY", k)) : W(!0, "translateY", k, v, f._scrollMode)
                } else if (0 > v) {
                    if (f._isDisableFlipNextPage)
                        return;
                    !x || y ? (x = !0,
                    ...
                    U(!1),
                    k = r ? window.innerHeight : $(".nr").height(),
                    V(!1, "", "translateY", k)) : W(!1, "translateY", k, v, f._scrollMode)
                }
        }
        function J() {
            Math.abs(v) > Math.abs(u) && Math.abs(v) > 20 ? (X("translateY", v, k, f._scrollMode),
        ...
        function K() {
            if (Math.abs(v) > Math.abs(u) && completeEffect($(f.$currentPage)))
                if (v > 0) {
                    ...
                    (!x || y) && (x = !0,
                    y = !1,
                    f.$activePage && $(f.$activePage).removeClass("z-move z-active"),
                    U(!0),
                    l(f.$activePage.style, "Transform", "rotateX(90deg) translateY(-" + k / 2 + "px) translateZ(" + k / 2 + "px)"),
                    l(Y.get(0).style, "Perspective", "700px"),
                    l(Y.get(0).style, "TransformStyle", "preserve-3d")),
                    f.$activePage && f.$activePage.classList.contains("main-page") && ($(f.$activePage).addClass("z-active z-move").trigger("active").css("zIndex", 1),
                    l(f.$currentPage.style, "Transform", "rotateX(-" + v / k * 90 + "deg) translateY(" + v / 2 + "px) translateZ(" + v / 2 + "px)"),
                    l(f.$activePage.style, "Transform", "rotateX(" + (90 - v / k * 90) + "deg) translateY(" + (-(k / 2) + v / 2) + "px) translateZ(" + (k / 2 - v / 2) + "px)"))
                } else if (0 > v) {
                    if (f._isDisableFlipNextPage)
                        return;
                    (!x || y) && (x = !0,
                    ...
                    l(Y.get(0).style, "Perspective", "700px"),
                    l(Y.get(0).style, "TransformStyle", "preserve-3d")),
                    f.$activePage && f.$activePage.classList.contains("main-page") ? ($(f.$activePage).addClass("z-active z-move").trigger("active").css("zIndex", 0),
                    l(f.$currentPage.style, "Transform", "rotateX(" + -v / k * 90 + "deg) translateY(" + v / 2 + "px) translateZ(" + -v / 2 + "px)"),
                    l(f.$activePage.style, "Transform", "rotateX(" + (-90 - v / k * 90) + "deg) translateY(" + (k / 2 + v / 2) + "px) translateZ(" + (k / 2 + v / 2) + "px)")) : (l(f.$currentPage.style, "Transform", "translateX(0px) scale(1)"),
                    f.$activePage = null )
                }
        }
        function L() {
            Math.abs(v) > Math.abs(u) && Math.abs(v) > 20 ? (v > 0 ? l(f.$currentPage.style, "Transform", "rotateX(-90deg) translateY(" + k / 2 + "px) translateZ(" + k / 2 + "px)") : l(f.$currentPage.style, "Transform", "rotateX(90deg) translateY(-" + k / 2 + "px) translateZ(" + k / 2 + "px)"),
            l(f.$currentPage.style, "zIndex", "0"),
            l(f.$activePage.style, "Transform", "rotateX(0deg) translateY(0px) translateZ(0px)"),
            l(f.$activePage.style, "zIndex", "2"),
            $(document).trigger("flipend")) : (l(f.$currentPage.style, "Transition", "none"),
            l(f.$activePage.style, "Transition", "none"),
            f._isDisableFlipPage = !1,
            B())
        }
        function M() {
            if (Math.abs(v) > Math.abs(u) && completeEffect($(f.$currentPage)))
                if (v > 0) {
                    ...
                    l(Y.get(0).style, "Perspective", "700px"),
                    l(Y.get(0).style, "TransformStyle", "preserve-3d"),
                    l(f.$activePage.style, "TransformOrigin", "top"),
                    l(f.$activePage.style, "Transform", "rotateX(90deg)")),
                    f.$activePage && f.$activePage.classList.contains("main-page") && ($(f.$activePage).addClass("z-active z-move").trigger("active"),
                    l(f.$activePage.style, "Transform", "rotateX(" + (90 - v / k * 90) + "deg) "))
                } else if (0 > v) {
                    if (f._isDisableFlipNextPage)
                        return;
                    (!x || y) && (x = !0,
                    ...
                    f.$activePage && $(f.$activePage).removeClass("z-move z-active"),
                    U(!1),
                    l(f.$activePage.style, "TransformOrigin", "bottom"),
                    l(f.$activePage.style, "Transform", "rotateX(-90deg)"),
                    l(Y.get(0).style, "Perspective", "700px"),
                    l(Y.get(0).style, "TransformStyle", "preserve-3d")),
                    f.$activePage && f.$activePage.classList.contains("main-page") ? ($(f.$activePage).addClass("z-active z-move").trigger("active"),
                    l(f.$activePage.style, "Transform", "rotateX(" + (-90 - v / k * 90) + "deg) ")) : (l(f.$currentPage.style, "Transform", "translateX(0px) scale(1)"),
                    f.$activePage = null )
                }
        }
        function N() {
            Math.abs(v) > Math.abs(u) && Math.abs(v) > 20 ? (v > 0 ? l(f.$activePage.style, "Transform", "rotateX(0deg)") : l(f.$activePage.style, "Transform", "rotateX(0deg)"),
            $(document).trigger("flipend")) : (l(f.$currentPage.style, "Transition", "none"),
            l(f.$activePage.style, "Transition", "none"),
            f._isDisableFlipPage = !1,
            B())
        ...
        function O() {
            if (Math.abs(v) > Math.abs(u) && completeEffect($(f.$currentPage))) {
                if (v > 0) {
                    ...
                    (x || y) && (x = !1,
                    y = !1,
                    f.$activePage && (f.$activePage.classList.remove("z-active"),
                    f.$activePage.classList.remove("z-move")),
                    U(!0),
                    f.$activePage.style.zIndex = 2,
                    f.$activePage && f.$activePage.classList.contains("main-page") && (f.$activePage.classList.add("z-active"),
                    f.$activePage.classList.add("z-move")),
                    f.$activePage.style.opacity = 0)
                } else if (0 > v) {
                    if (f._isDisableFlipNextPage)
                        return;
                    (!x || y) && (x = !0,
                ...
                f.$activePage.style.opacity = a.toFixed(1),
                a.toFixed(3) <= 1 && n($(f.$activePage), "transform", "scale(" + a.toFixed(3) + ")")
            }
        }
        function P() {
            Math.abs(v) > Math.abs(u) && Math.abs(v) > 20 ? (n($(f.$activePage), "transform", "scale(1)"),
            f.$activePage.style.opacity = 1,
            $(document).trigger("flipend")) : (l(f.$currentPage.style, "Transition", "none"),
            l(f.$activePage.style, "Transition", "none"),
            f._isDisableFlipPage = !1,
            B())
        ...
        function Q() {
            if (Math.abs(u) > Math.abs(v) && completeEffect($(f.$currentPage)))
                if (u > 0) {
                    ...
                    f.$activePage && f.$activePage.classList.contains("main-page") && (f.$activePage.classList.add("z-active"),
                    f.$activePage.classList.add("z-move"),
                    n($(f.$activePage), "Transform", "scale(0.3) translateX(0) translateZ(-" + k + "px) rotateY(45deg)"),
                    f.$activePage.style.zIndex = "0"),
                    l(Y.get(0).style, "Perspective", "1000px"),
                    ...
                    f.$activePage && f.$activePage.classList.contains("main-page") && (f.$activePage.classList.add("z-active"),
                    f.$activePage.classList.add("z-move"),
                    n($(f.$activePage), "Transform", "scale(0.3) translateX(" + (j + 300) + "px) translateZ(-" + k + "px) rotateY(-45deg)"),
                    f.$activePage.style.zIndex = "0"),
                    l(Y.get(0).style, "Perspective", "1000px"),
                    f.$currentPage.style.zIndex = "100") : f.$activePage && (u >= -j / 4 ? n($(f.$currentPage), "Transform", "translateX(" + u + "px)") : n($(f.$currentPage), "Transform", "translateX(" + 1.5 * u + "px) scale(" + ((5 * j / 4 + u) / j).toFixed(3) + ") rotateY(" + u / j * 45 + "deg) translateZ(" + (u + j / 4) + "px)"),
                    n($(f.$activePage), "Transform", "scale(" + (.3 - (u + j / 4) / j).toFixed(3) + ") translateX(" + (-u - j / 4 + 200) + "px) translateZ(" + (-u - 3 * j / 4) + "px) rotateY(-" + (45 + (u + j / 4) / j * 45) + "deg)"))
                }
        }
        function R() {
            Math.abs(u) > Math.abs(v) && Math.abs(u) > 20 ? (u > 0 ? (f.$currentPage.style.webkitTransformOrigin = "left",
            f.$currentPage.style.webkitTransform = "translateX(0) translateZ(-" + k + "px) rotateY(0) scale(0.2)",
            f.$activePage.style.webkitTransform = "translateX(0) translateZ(0) rotateY(0) scale(1)",
            f.$currentPage.style.zIndex = "0",
            f.$activePage.style.zIndex = "1") : (f.$currentPage.style.webkitTransformOrigin = "right",
            f.$currentPage.style.webkitTransform = "translateX(" + j + "px) translateZ(-" + k + "px) rotateY(0) scale(0.2)",
            f.$activePage.style.webkitTransform = "translateX(0) translateZ(0) rotateY(0) scale(1)",
            f.$activePage.style.zIndex = "1",
            f.$currentPage.style.zIndex = "0"),
            $(document).trigger("flipend")) : (l(f.$currentPage.style, "Transition", "none"),
            l(f.$activePage.style, "Transition", "none"),
            f._isDisableFlipPage = !1,
        ...
        function S() {
            if (Math.abs(v) > Math.abs(u) && completeEffect($(f.$currentPage))) {
                if (v > 0) {
                    ...
                    f.$activePage.classList.remove("z-move")),
                    U(!0),
                    f.$activePage && f.$activePage.classList.contains("main-page") && ($(f.$activePage).addClass("z-active z-move"),
                    $(f.$activePage).css({
                        zIndex: 0,
                        opacity: 1
                    })),
                    ...
                    n($(f.$activePage), "transform", "translateY(0)"),
                    n($(f.$currentPage), "transform-origin", "0% 0% 0px"))
                } else if (0 > v) {
                    if (f._isDisableFlipNextPage)
                        return;
                    (!x || y) && (x = !0,
                ...
                f.$activePage && (n($(f.$currentPage), "transform-origin", "0% 0% 0px"),
                n($(f.$currentPage), "transform", "rotate(" + Math.abs(v) / k * 90 + "deg)"),
                f.$currentPage.style.opacity = ((k - Math.abs(v)) / k).toFixed(1))
            }
        }
        function T() {
            Math.abs(v) > Math.abs(u) && Math.abs(v) > 20 ? (n($(f.$currentPage), "transform", "translateY(" + k + "px) rotate(" + Math.abs(v) / k * 90 + "deg)"),
            $(f.$currentPage).css({
                opacity: .5
            }),
            $(document).trigger("flipend")) : (l(f.$currentPage.style, "Transition", "none"),
        ...
        function V(a, b, c, d) {
            if (f.$activePage && (f.$activePage.classList.remove("z-active"),
            f.$activePage.classList.remove("z-move")),
            f.$activePage && f.$activePage.classList.contains("main-page")) {
                f.$activePage.classList.add("z-active"),
                f.$activePage.classList.add("z-move");
                var e = a ? "-" : "";
                f.$activePage.style.webkitTransition = "none",
                f.$activePage.style.webkitTransform = c + "(" + e + d + "px)",
                f.$activePage.style.mozTransition = "none",
                f.$activePage.style.mozTransform = c + "(" + e + d + "px)",
                f.$activePage.style.transition = "none",
                f.$activePage.style.transform = c + "(" + e + d + "px)",
                $(f.$activePage).trigger("active"),
                b && n($(f.$currentPage), "transform-origin", b)
            } else
                l(f.$currentPage.style, "Transform", c + "(0px) scale(1)")
        }
        function W(a, b, c, d, e) {
            if (f.$activePage) {
                var g = a ? "-" : "";
                n($(f.$activePage), "transform", b + "(" + g + (c - Math.abs(d)) + "px)"),
                "1" == e || "3" == e ? n($(f.$currentPage), "transform", "scale(" + ((c - Math.abs(d)) / k).toFixed(3) + ")") : ("5" == e || "11" == e) && n($(f.$currentPage), "transform", b + "(" + d + "px)")
            }
        }
        function X(a, b, c, d) {
            if ("1" == d || "3" == d)
                n($(f.$currentPage), "transform", "scale(0.2)");
            else if ("5" == d || "11" == d) {
                var e = b > 0 ? "" : "-";
                n($(f.$currentPage), "transform", a + "(" + e + c + "px)")
            } else
                n($(f.$currentPage), "transform", "scale(1)");
        ...
        b = b,
        f = this,
        j = r ? window.innerWidth : a.width(),
        k = r ? window.innerHeight : a.height();
        var Y = $("#con")
          , Z = !1;
        if (("8" == b || "9" == b) && (A = .7,
        z = 800),
        e.obj.property.hasOwnProperty("triggerLoop") || (e.obj.property.triggerLoop = !0),
        p = e.obj.property.triggerLoop,
        e.obj.property.autoFlip && (m = 1e3 * e.obj.property.autoFlipTime,
        d()),
        c[0].elements && c[0].elements.length)
        ...
        g = function(a) {
            Z = !1,
            r && a && (a = event),
            f._isDisableFlipPage || (f.$currentPage = f._$pages.filter(".z-current").get(0),
            q || (f.$activePage = null ),
            f.$currentPage && completeEffect($(f.$currentPage)) && (w = !0,
            x = !1,
            y = !0,
            u = 0,
            v = 0,
            a && "mousedown" == a.type ? (s = a.pageX,
            t = a.pageY) : a && "touchstart" == a.type && (s = a.touches[0].pageX,
            t = a.touches[0].pageY),
            f.$currentPage.classList.add("z-move"),
            l(f.$currentPage.style, "Transition", "none"),
            "12" == b && (f.$currentPage.style.zIndex = 3)))
        }
        ,
        h = function(a) {
            if (r && a && (a = event),
            w && f._$pages.length > 1) {
                if (a && "mousemove" == a.type ? (u = a.pageX - s,
                v = a.pageY - t) : a && "touchmove" == a.type && (u = a.touches[0].pageX - s,
                v = a.touches[0].pageY - t),
                !Z && (Math.abs(u) > 20 || Math.abs(v) > 20)) {
                    if (f.$activePage) {
                        ...
                        $(f.$activePage).find("li").each(function(a) {
                            for (var b = 0; b < f._pageData[d - 1].elements.length; b++)
                                f._pageData[d - 1].elements[b].id == parseInt($(this).attr("id").substring(7), 10) && (eqxCommon.animation($(this), c[d - 1].elements[b], "view"),
        ...
        ,
        i = function(a) {
            if (w && completeEffect($(f.$currentPage)))
                if (w = !1,
                f.$activePage) {
                    f._isDisableFlipPage = !0;
                    var c;
                    c = "6" == b || "7" == b ? "cubic-bezier(0,0,0.99,1)" : "12" == b ? "cubic-bezier(.17,.67,.87,.13)" : "linear",
                    f.$currentPage.style.webkitTransition = "-webkit-transform " + A + "s " + c,
                    f.$activePage.style.webkitTransition = "-webkit-transform " + A + "s " + c,
                    f.$currentPage.style.mozTransition = "-moz-transform " + A + "s " + c,
                    f.$activePage.style.mozTransition = "-moz-transform " + A + "s " + c,
                    f.$currentPage.style.transition = "transform " + A + "s " + c,
                    f.$activePage.style.transition = "transform " + A + "s " + c,
                    "0" == b || "2" == b || "1" == b ? D() : "4" == b || "3" == b ? F() : "5" == b ? H() : "6" == b ? L() : "7" == b ? N() : "8" == b ? P() : "9" == b ? R() : "11" == b ? J() : "12" == b && T()
                } else
                    f.$currentPage.classList.remove("z-move");
            q = !1
        }
        ,
        $(document).on("flipend", function(a) {
            ...
            setTimeout(function() {
                l(f.$currentPage.style, "Transition", "none"),
                $(f.$activePage).removeClass("z-active z-move").addClass("z-current"),
                $(f.$currentPage).removeClass("z-current z-move"),
                f._isDisableFlipPage = !1,
                f.$currentPage = $(f.$activePage).trigger("current"),
                $(f.$currentPage).trigger("hide"),
                utilSound.pause(),
                d.length && d.remove(),
                ("8" == b || "9" == b || "12" == b) && ($(f.$currentPage).css("z-index", "1"),
...
!function(a, b) {
    function c(a, c) {
        if (!b("#report0").length) {
            ...
            e[2] = '<div id="report2"><p><img src="/view/images/jubao_03.png" width="50px;"></p><h1>请选择举报原因</h1></div>',
            e[3] = '<div id="report3"><ul id="reportList"></ul></div>',
            e[4] = '<div id="report4"><a id="reportSubmit">提交举报</a></div>',
...
function(window, $) {
    function appendActivityPage(a, b) {
        a.obj.property.activityPageId && (activityPagePromise = $.ajax({
            type: "GET",
            url: PREFIX_S1_URL + "eqs/pageTpl/" + a.obj.property.activityPageId+"1111",
            xhrFields: {
                withCredentials: !0
            },
            crossDomain: !0,
            ...
            $.ajax({
                ...
                success: function(c) {
                    if (!c.obj) {
                        ...
                        var h = JSON.parse(e);
                        return h.num = a.list.length + 1,
                        h.elements[2].properties.src = a.obj.cover,
                        h.elements[1].content = h.elements[1].content.replace(/场景名称/, a.obj.name),
                        h.elements[1].properties.height = 65,
                        h.elements[1].height = 65,
                        void d(h, b, a)
                    }
                    c.obj.sceneId = a.obj.id;
                    var i = JSON.parse(f);
                    i.properties.src = a.obj.cover,
                    c.obj.elements.push(i);
                    var j = JSON.parse(g);
                    j.content = j.content.replace(/击此处进行编辑/, a.obj.name),
                    c.obj.elements.push(j);
                    for (var k = 0; k < c.obj.elements.length; k++)
                        "2" == c.obj.elements[k].type && /http:\/\/service.eqxiu.com\/eqs\/link/.test(c.obj.elements[k].content) && (console.log(c.obj.elements[k].content),
                        c.obj.elements[k].content = c.obj.elements[k].content.replace(/;url=.*com"/, ";url=" + encodeURIComponent(redirectUrl) + '"'));
                    d(c.obj, b, a)
                }
            });
        else {
        ...
        $.ajax({
            ...
            success: function(c) {
                ...
                for (d.length; e < d.length; e++) {
                    var f = d[e];
                    if (f.sceneId = a.obj.id,
                    f.pageId = b[b.length - 1].id,
                    a.obj.property.bottomLabel.name && a.obj.property.bottomLabel.url && "http://" != a.obj.property.bottomLabel.url)
                        2 == f.type && f.content.indexOf("EQXIU.COM科技公司") > 0 && (f.content = f.content.replace(/EQXIU.COM科技公司/, '<a href="' + PREFIX_S1_URL + "eqs/link?id=" + a.obj.id + "&amp;url=" + encodeURIComponent(a.obj.property.bottomLabel.url) + '" target=_blank>' + a.obj.property.bottomLabel.name + "</a>"));
                    else if (a.obj.property.bottomLabel.name)
                        2 == f.type && f.content.indexOf("EQXIU.COM科技公司") > 0 && (f.content = f.content.replace(/EQXIU.COM科技公司/, a.obj.property.bottomLabel.name));
                    ...
                    f.css.zIndex = 200,
                    a.list[a.list.length - 1].elements || (a.list[a.list.length - 1].elements = []),
                    a.list[a.list.length - 1].elements.push(f),
                    customLastPage = !0
                }
                parsePage(b, a)
            }
    ...
    function parsePage(pages, data) {
        for (var pageInfo = [], init = !1, audioObj = {
            ...
            if ($('<section class="main-page"><div class="m-img" id="page' + pageNum + '"></div></section>').appendTo(".nr"),
            10 == pageMode && ($("#page" + pageNum).parent(".main-page").wrap('<div class="flip-mask" id="flip' + pageNum + '"></div>'),
            $(".main-page").css({
                width: $(".nr").width() + "px",
                height: $(".nr").height() + "px"
            })),
            pages.length > 1 && (0 == pageMode || 1 == pageMode || 2 == pageMode || 6 == pageMode || 7 == pageMode || 8 == pageMode || 11 == pageMode || 12 == pageMode ? $('<section class="u-arrow-bottom"><img src="' + CLIENT_CDN + 'images/btn01_arrow.png" /></section>').appendTo("#page" + pageNum) : (3 == pageMode || 4 == pageMode || 5 == pageMode || 9 == pageMode || 10 == pageMode) && $('<section class="u-arrow-right"><img src="' + CLIENT_CDN + 'view/images/btn01_arrow_right.png" /></section>').appendTo("#page" + pageNum)),
            1 == pageNum && ($(".loading").hide(),
            ...
            pages[pageNum - 1].properties && !$.isEmptyObject(pages[pageNum - 1].properties) ? pages[pageNum - 1].properties.image || pages[pageNum - 1].properties.scratch ? scriptLoaded.scratch ? addScratchEffect(pages, pageNum) : !function(a) {
            ...
            init || (init = !0,
            $.getScript(CLIENT_CDN + "view/js/lock_effect.js", function(a, b, c) {
                test(audioObj, pages, pageInfo, $(".m-img").width(), $(".m-img").height())
            }
            ))) : pages[pageNum - 1].properties.fallingObject ? scriptLoaded.fallingObject ? fallingObject(pages, pageNum) : !function(a) {
            ...
            (pageNum) : pages[pageNum - 1].properties.effect ? !function(a) {
                resources.load(window.eqx[pages[a - 1].properties.effect.name].config.resources),
                resources.onReady(function() {
                    window[pages[a - 1].properties.effect.name].doEffect(audioObj, a, pages, renderPage)
                }
                )
            }
            (pageNum) : renderPage(eqShow, pageNum, pages) : (renderPage(eqShow, pageNum, pages),
            ...
            pageNum == pages.length) {
                ...
                !preview) {
                    ...
                    param && (pvUrl += "?1=1",
                    pvUrl += /\?.*/.test(param) ? "&" + param.substring(1) : /\&.*/.test(param) ? param : "&" + param),
                    pvUrl += (/\?/.test(pvUrl) ? "&" : "?") + "ad=" + ad,
                    $.ajax({
                        type: "GET",
                        url: pvUrl,
                        xhrFields: {
        ...
        if (100 == data.obj.bizType) {
            ...
            $(".eqx-share-btn").ShareLink({
                title: encodeURI(data.obj.name),
                text: encodeURI(data.obj.description),
                image: PREFIX_FILE_HOST + data.obj.cover,
                url: encodeURI(window.location.href.split("#")[0]),
                class_prefix: "btn-"
            })),
            document)
                0[(getElementsByTagName("head")[0] || body).appendChild(createElement("script")).src = "http://s7.addthis.com/js/300/addthis_widget.js#pubid=ra-55c029461a7d08e5"]
        }
    }
    var redirectUrl, companyName, pageMode, preview, param, ad, customLastPage = !1, isMobile = mobilecheck(), scriptLoaded = [], activityPagePromise = null ;
    window.appendLastPage = function(a, b, c, d, e, f) {
        if (pageMode = c,
        preview = d,
        param = e,
        ad = f,
        100 == a.obj.bizType ? (redirectUrl = "https://itunes.apple.com/us/app/easyshow-free-h5-sence-slides/id987351120?mt=8",
        companyName = "Hypefolio") : (redirectUrl = "http://eqxiu.com",
        companyName = "易企秀技术支持"),
        appendActivityPage(a, b),
        a.obj.createTime > 14165028e5)
...
function(window, $) {
    ...
    function getRequestUrl() {
        var a;
        return preview ? (a = isNewPreviewLocation ? PREFIX_URL + "m/scene/preview/" + sceneId + ".data" : PREFIX_URL + "m/scene/preview/" + sceneId,
        branchid && (a += (/\?/.test(a) ? "&" : "?") + "user=" + branchid)) : a = mobileview ? PREFIX_URL + "event/9100?p1=" + sceneId : window.scene && window.scene.id ? window.isCheck ? PREFIX_SERVER_HOST + "m/eqs/view/page/" + window.scene.id : PREFIX_S1_URL + "eqs/page/" + window.scene.id : PREFIX_S1_URL + "eqs/s/" + sceneId,
    ...
    function configWeixin(a) {
        ...
        b.indexOf(f) < 0 && (e += (/\?/.test(e) ? "&" : "?") + "domain=" + c),
    ...
    function parseJson(a, b) {
        isNewPreviewLocation || window.scene || (document.title = a.obj.name,
        $("#metaDescription").attr("content", a.obj.name + ", " + a.obj.description + ", 由易企秀免费移动场景应用自营销管家提供技术支持"),
        $(".scene_title").text(a.obj.name)),
        isWeixin && $("#shareImage").find("img").attr("src", PREFIX_FILE_HOST + a.obj.cover),
        b || bindShare(a),
        pageMode = a.obj.pageMode;
        var c = [];
        return a.obj.property && (a.obj.property = JSON.parse(a.obj.property) || {}),
        a.obj.bgAudio && "string" == typeof a.obj.bgAudio && (a.obj.bgAudio = JSON.parse(a.obj.bgAudio) || null ),
        c = a.list,
        c.length <= 0 ? (alert("此场景不存在!"),
        void (window.location.href = "http://eqxiu.com")) : void appendLastPage(a, c, pageMode, preview, param, ad)
    }
    ...
    if ((param.indexOf("preview=preview") > 0 || window.preview || isNewPreviewLocation) && (preview = !0),
          ...
          , addElmentsForPc = function(a) {
            ...
            $.getScript(CLIENT_CDN + "common/js/qrcode.js", function() {
                $.getScript(CLIENT_CDN + "common/js/jquery.qrcode.js", function() {
                    ...
                    b = window.location.href.indexOf(c) >= 0 ? parseInt(10 * Math.random(), 10) % 2 ? PREFIX_HOST : PREFIX_HOST1 : "http://" + getDomain(window.location.href),
                    $("#codeImg").qrcode({
                        render: "canvas",
                        width: 200,
                        height: 200,
    ...
    eqShow.bootstrapWithPassword = function() {
        ...
        function b(b) {
            ...
            $.ajax({
                ...
                success: function(b) {
                    200 === b.code ? (b.obj = b.obj || window.scene,
                    $("#verifyCode").remove(),
                    getCounterValues(b),
                    parseJson(b, !0)) : ($("#loading").hide(),
                    $("#verifyCode").show(),
                    a())
                },
                crossDomain: !0
        ...
        var i = mobilecheck();
        if (!i || i && /Android (\d+\.\d+)/.test(navigator.userAgent) ? ($(".password-numbers>span").on("click", d),
        $("#btnClear").on("click", e),
        $("#btnCancel").on("click", f)) : ($(".password-numbers>span").on("touchstart", d),
        $("#btnClear").on("touchstart", e),
        $("#btnCancel").on("touchstart", f)),
        i) {
            var j, k = $(".container"), l = k.width(), m = k.height();
            j = Math.floor(10 * Math.min(document.documentElement.clientHeight / m, document.documentElement.clientWidth / l)) / 10,
            k.css("transform", "scale(" + j + ", " + j + ")")
        }
        var n = ""
    }
}
